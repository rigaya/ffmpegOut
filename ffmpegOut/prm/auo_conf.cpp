...
int guiEx_config::load_auo_conf(CONF_GUIEX *conf, const char *stg_file) {
	size_t conf_size = 0;
	BYTE *dst, *filedat;
	//初期化
...
int guiEx_config::save_auo_conf(const CONF_GUIEX *conf, const char *stg_file) {
